<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/goods/add'}">首页</el-breadcrumb-item>
      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品图片" name="3">
            <!-- action 表示图片要上传的地址 on-preview 表示预览的事件 -->
            <el-upload
              :action="uploadUrl"
...
export default {
  ...
  methods: {
    ...
    handleRemove(file) {
       ...
       */
      const filePath = file.response.data.tmp_path // 1
      const i = this.addForm.pics.findIndex(
        x => x.pic === filePath // findIndex 该条件成立，返回对应的索引值
      )
